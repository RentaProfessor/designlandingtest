export default function About() {
  return (
    <section 
      id="about" 
      className="min-h-screen flex flex-col items-center justify-center px-[5%] py-24 bg-gradient-to-br from-sand-100 to-sand-200"
    >
      <div className="max-w-5xl w-full text-center">
        <h2 className="font-serif text-4xl md:text-6xl font-normal text-brown-800 mb-4 tracking-wide">
          About Us
        </h2>
        <p className="font-sans text-lg md:text-xl text-brown-400 mb-12 font-light leading-relaxed">
          Creating extraordinary outdoor spaces that blend beauty, functionality, and sustainability
        </p>
        
        <div className="bg-white p-10 inline-block shadow-lg mb-12 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
          <img 
